...
import RequestDemoModal from '../components/requestDemoModal'; // Renamed import
...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Education Reimagined</title>
        <meta name="description" content="Upskilling the nation with innovative education solutions." />
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/images/backgroundtop@2x.png')",
        }}
      >
        ...
        <div className="relative z-10 w-full max-w-screen-lg flex flex-col md:flex-row items-center justify-center text-center md:text-left px-4 md:px-8 space-y-6 md:space-y-0">
          ...
          <Image
            src="/images/womantopbanner@2x.png"
            alt="Banner Image"
      ...
      <div className="bg-gray-100 py-12">
        ...
        <div className="flex flex-wrap gap-8 justify-center">
          {/* Cards for Online Learning */}
          {[
            {
              src: '/images/checkbox white.svg',
              title: 'Video content trusted by over 100k students',
            ...
            },
            {
              ...
              title: 'Researched and produced by experts',
              description: 'Lorem ipsum is placeholder text commonly used in the graphic, print.',
              bgColor: 'bg-gray-200',
            ...
            },
            {
              ...
              title: 'Approved by grads and industry experts',
              description: 'Lorem ipsum is placeholder text commonly used in the graphic, print.',
            ...
            {
              src: '/images/checkbox white.svg',
              title: 'Build on community and transparency',
              description: 'Lorem ipsum is placeholder text commonly used in the graphic, print.',
              bgColor: 'bg-blue-600',
              textColor: 'text-white',
            },
            ...
            <div
              key={index}
              className={`${card.bgColor} ${card.textColor} p-6 rounded-lg flex flex-col items-center w-full sm:w-72`}
            >
              <Image
                src={card.src}
                alt={card.title}
              ...
              />
              <p className="text-lg font-semibold mt-4 text-center">{card.title}</p>
        ...
        <div className="max-w-screen-xl mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {[
              ...
              <div
                key={index}
                className="bg-white shadow-xl rounded-xl p-6 text-center transition-transform transform hover:scale-105 hover:shadow-2xl"
              >
                <img
                  src={course.src}
                  alt={course.title}
      ...
      <div className="container mx-auto px-5 py-10" style={{ background: '#8CC7E3' }}>
        <div className="text-center mb-8">
          ...
          <div className="h-1 w-24 mx-auto bg-indigo-500 mt-2"></div>
        </div>
