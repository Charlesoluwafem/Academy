  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-100">
      ...
      <header className="bg-[#c4a589] p-4 flex justify-between items-center text-white">
        <h1 className="text-lg font-bold">Academy Powered by MA</h1>
      ...
      {/* Footer */}
      <footer className="bg-[#c4a589] text-white p-4 flex justify-center">
        <p>Academy &copy; 2025. All Rights Reserved.</p>
      </footer>
    </div>
  );
}
